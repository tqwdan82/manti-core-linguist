...
opEditorApp.controller('opEditorCtrl', function($scope) {
    ...
    $scope.init = function(){
        if($scope.operation){
            ...
            httpPostAsync("../../fms/maestro/api/getOperationContent", input, httpCallback);
        }else{
            $scope.editor = ace.edit("editor");
            let r = function(f){/in/.test(document.readyState)?setTimeout('r('+f+')',9):f()}
            r(function(){
    ...
    $scope.saveOperation = function(){
        ...
        httpPostAsync("../../fms/maestro/api/saveOperation", input, httpCallback);
    };
});
...
opApp.controller('opAppCtrl', function($scope) {
    ...
    $scope.init = function(){
        ...
        httpGetAsync("../../fms/maestro/api/getAllServices", {}, httpCallback);
    };
    ...
    $scope.deleteOperation = function(appName, serviceName, opName){
        ...
        httpPostAsync("../../fms/maestro/api/delOperation", input, httpCallback);
    }
...
svcNew.controller('svcNewCtrl', function($scope) {
    ...
    $scope.createApplication = function(){
        ...
        httpPostAsync("../../fms/maestro/api/createApplication",input, httpCallback);
...
svcViewApp.controller('svcViewCtrl', function($scope) {
    ...
    $scope.deleteService = function(appName, serviceName){
        ...
        httpPostAsync("../../fms/maestro/api/delService",input, httpCallback);
    };
    $scope.deleteApplication = function(appName){
        ...
        httpPostAsync("../../fms/maestro/api/delApplication",input, httpCallback);
    };
    ...
    $scope.createNewService = function(){
        ...
        httpPostAsync("../../fms/maestro/api/createService", input, httpCallback);
